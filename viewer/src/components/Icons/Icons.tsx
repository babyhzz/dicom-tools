...
import CTAAA from "./images/CT-AAA.png";
import CTAAA2 from "./images/CT-AAA2.png";
import CTAir from "./images/CT-Air.png";
import CTBone from "./images/CT-Bone.png";
import CTBones from "./images/CT-Bones.png";
import CTCardiac from "./images/CT-Cardiac.png";
import CTCardiac2 from "./images/CT-Cardiac2.png";
import CTCardiac3 from "./images/CT-Cardiac3.png";
import CTChestContrastEnhanced from "./images/CT-Chest-Contrast-Enhanced.png";
import CTChestVessels from "./images/CT-Chest-Vessels.png";
import CTCoronaryArteries from "./images/CT-Coronary-Arteries.png";
import CTCoronaryArteries2 from "./images/CT-Coronary-Arteries-2.png";
import CTCoronaryArteries3 from "./images/CT-Coronary-Arteries-3.png";
import CTCroppedVolumeBone from "./images/CT-Cropped-Volume-Bone.png";
import CTFat from "./images/CT-Fat.png";
import CTLiverVasculature from "./images/CT-Liver-Vasculature.png";
import CTLung from "./images/CT-Lung.png";
import CTMIP from "./images/CT-MIP.png";
import CTMuscle from "./images/CT-Muscle.png";
import CTPulmonaryArteries from "./images/CT-Pulmonary-Arteries.png";
import CTSoftTissue from "./images/CT-Soft-Tissue.png";
import DTIFABrain from "./images/DTI-FA-Brain.png";
import MRAngio from "./images/MR-Angio.png";
import MRDefault from "./images/MR-Default.png";
import MRMIP from "./images/MR-MIP.png";
import MRT2Brain from "./images/MR-T2-Brain.png";
import VolumeRendering from "./images/VolumeRendering.png";
...
export const Icons = {
  "CT-AAA": (props: ImageIconProps) => <ImageWrapper src={CTAAA} {...props} />,
  "CT-AAA2": (props: ImageIconProps) => (
    <ImageWrapper src={CTAAA2} {...props} />
  ),
  "CT-Air": (props: ImageIconProps) => <ImageWrapper src={CTAir} {...props} />,
  "CT-Bone": (props: ImageIconProps) => (
    <ImageWrapper src={CTBone} {...props} />
  ),
  "CT-Bones": (props: ImageIconProps) => (
    <ImageWrapper src={CTBones} {...props} />
  ),
  "CT-Cardiac": (props: ImageIconProps) => (
    <ImageWrapper src={CTCardiac} {...props} />
  ),
  "CT-Cardiac2": (props: ImageIconProps) => (
    <ImageWrapper src={CTCardiac2} {...props} />
  ),
  "CT-Cardiac3": (props: ImageIconProps) => (
    <ImageWrapper src={CTCardiac3} {...props} />
  ),
  "CT-Chest-Contrast-Enhanced": (props: ImageIconProps) => (
    <ImageWrapper src={CTChestContrastEnhanced} {...props} />
  ),
  "CT-Chest-Vessels": (props: ImageIconProps) => (
    <ImageWrapper src={CTChestVessels} {...props} />
  ),
  "CT-Coronary-Arteries": (props: ImageIconProps) => (
    <ImageWrapper src={CTCoronaryArteries} {...props} />
  ),
  "CT-Coronary-Arteries-2": (props: ImageIconProps) => (
    <ImageWrapper src={CTCoronaryArteries2} {...props} />
  ),
  "CT-Coronary-Arteries-3": (props: ImageIconProps) => (
    <ImageWrapper src={CTCoronaryArteries3} {...props} />
  ),
  "CT-Cropped-Volume-Bone": (props: ImageIconProps) => (
    <ImageWrapper src={CTCroppedVolumeBone} {...props} />
  ),
  "CT-Fat": (props: ImageIconProps) => <ImageWrapper src={CTFat} {...props} />,
  "CT-Liver-Vasculature": (props: ImageIconProps) => (
    <ImageWrapper src={CTLiverVasculature} {...props} />
  ),
  "CT-Lung": (props: ImageIconProps) => (
    <ImageWrapper src={CTLung} {...props} />
  ),
  "CT-MIP": (props: ImageIconProps) => <ImageWrapper src={CTMIP} {...props} />,
  "CT-Muscle": (props: ImageIconProps) => (
    <ImageWrapper src={CTMuscle} {...props} />
  ),
  "CT-Pulmonary-Arteries": (props: ImageIconProps) => (
    <ImageWrapper src={CTPulmonaryArteries} {...props} />
  ),
  "CT-Soft-Tissue": (props: ImageIconProps) => (
    <ImageWrapper src={CTSoftTissue} {...props} />
  ),
  "DTI-FA-Brain": (props: ImageIconProps) => (
    <ImageWrapper src={DTIFABrain} {...props} />
  ),
  "MR-Angio": (props: ImageIconProps) => (
    <ImageWrapper src={MRAngio} {...props} />
  ),
  "MR-Default": (props: ImageIconProps) => (
    <ImageWrapper src={MRDefault} {...props} />
  ),
  "MR-MIP": (props: ImageIconProps) => <ImageWrapper src={MRMIP} {...props} />,
  "MR-T2-Brain": (props: ImageIconProps) => (
    <ImageWrapper src={MRT2Brain} {...props} />
  ),
  VolumeRendering: (props: ImageIconProps) => (
    <ImageWrapper src={VolumeRendering} {...props} />
  ),
  // Icons
  LayerBackground,
  LayerForeground,
  ...
  "logo-dark-background": (props: IconProps) =>
    OHIFLogoColorDarkBackground(props),
  ...
  "icon-labelmap-slice-propagation": (props: IconProps) =>
    ToolLabelmapAssist(props),
  ...
  "icon-tool-bidirectional-segment": (props: IconProps) =>
    ToolBidirectionalSegment(props),
  ...
  "tool-ultrasound-bidirectional": (props: IconProps) =>
    ToolUltrasoundBidirectional(props),
  ...
  "icon-tool-ultrasound-bidirectional": (props: IconProps) =>
    ToolUltrasoundBidirectional(props),
  ...
  "notificationwarning-diamond": (props: IconProps) =>
    NotificationWarning(props),
  ...
  "layout-advanced-3d-four-up": (props: IconProps) =>
    LayoutAdvanced3DFourUp(props),
  ...
  "layout-advanced-3d-primary": (props: IconProps) =>
    LayoutAdvanced3DPrimary(props),
  "layout-advanced-axial-primary": (props: IconProps) =>
    LayoutAdvancedAxialPrimary(props),
  ...
  "actions-combine-subtract": (props: IconProps) =>
    ActionsCombineSubtract(props),
  "actions-combine-intersect": (props: IconProps) =>
    ActionsCombineIntersect(props),
  ...
  "helper-combine-intersect": (props: IconProps) =>
    HelperCombineIntersect(props),
